...
function captureDivToClipboardDesktop() {
...
function captureDivToClipboardMobile() {
    var div = document.querySelector('#editor .ql-editor');
    var originalHeight = div.style.height;
...
function GetScreenWidth() {
    console.log('reached from javascript ' + window.innerWidth);
    return window.innerWidth;
}

function GetScreenHeight() {
    console.log('reached from javascript ' + window.innerHeight);
    return window.innerHeight;
}

function enableContextMenuOnEditor() {
...
// Call the function after the controls are rendered
document.addEventListener('DOMContentLoaded', (event) => {
    enableContextMenuOnEditor();
});

function GetDivHeight() {
    var editorDiv = document.getElementById('editor');
    return editorDiv.clientHeight;
}
